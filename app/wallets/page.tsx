        ...
        <div className="min-h-screen bg-background pb-32 pt-6 px-6 animate-in fade-in duration-500">
            ...
            {/* Modal */}
            {
                showModal && (
                    ...
                    >
                        <div
                            className="bg-background border border-border rounded-3xl p-6 max-w-md w-full shadow-2xl animate-in slide-in-from-bottom-10 duration-300"
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="space-y-3 pt-2">
                                    <p className="text-sm font-medium border-t border-border pt-4">Spending Limits (0 for no limit)</p>
                                    <div className="grid grid-cols-3 gap-3">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 py-2 bg-secondary border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                                                placeholder="0"
                                            />
                                        </div>
                                        <div>
                                ...
                                <div className="flex gap-3 pt-4">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isSubmitting}
                                        className="flex-1 px-4 py-3 bg-primary text-primary-foreground rounded-xl font-semibold hover:bg-primary/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                                        {isSubmitting ? (
                                            <>
                                                <svg
